...
__all__ = [
    'SPWT_PRONUNCIATION', 'DISPID_SDKGetlongValue',
    'SAFT22kHz8BitStereo', 'DISPID_SRGCmdLoadFromMemory', 'SPAR_Low',
    'DISPID_SRGState', 'SAFT8kHz16BitMono',
    'DISPID_SpeechPhraseReplacements', 'SpeechEngineProperties',
    'SPLOADOPTIONS', 'SRAORetainAudio', 'DISPID_SWFEExtraData',
    'DISPID_SpeechPhraseReplacement', 'SpeechAudioFormatGUIDWave',
    'SPPS_Function', 'DISPID_SRRAudioFormat', 'DISPID_SPIGetText',
    'DISPID_SpeechPhraseRule', 'SPAO_NONE',
    'ISpeechLexiconPronunciations', 'eLEXTYPE_PRIVATE13',
    'SGDSActive', 'DISPID_SCSBaseStream', 'ISpeechGrammarRule',
    'DISPID_SAFGuid', 'SFTSREngine', 'eLEXTYPE_PRIVATE16',
    'DISPID_SPRulesCount', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SpMMAudioEnum', 'DISPID_SRRRecoContext', 'SAFT48kHz16BitMono',
    'SPXMLRESULTOPTIONS', 'DISPID_SPRuleFirstElement', 'SPFM_CREATE',
    'SPBO_NONE', 'DISPID_SRRAlternates',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'eLEXTYPE_PRIVATE18',
    'DISPID_SVSPhonemeId', 'SPEI_PROPERTY_STRING_CHANGE',
    'SAFTCCITT_ALaw_22kHzStereo', 'ISpSerializeState',
    'DISPID_SPPsCount', 'SECNormalConfidence',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SPDKL_DefaultLocation', 'SpeechFormatType', 'SP_VISEME_0',
    'SpeechPropertyResponseSpeed', 'SECHighConfidence', 'SVP_15',
    'SAFT22kHz16BitMono', 'SAFTADPCM_22kHzStereo',
    'SPADAPTATIONRELEVANCE', 'DISPID_SRGSetWordSequenceData',
    'SPVPRI_OVER', 'SPCT_SUB_COMMAND', 'SVF_Stressed',
    'SpeechRuleAttributes', 'SDA_One_Trailing_Space',
    'DISPID_SRCCmdMaxAlternates', 'SpTextSelectionInformation',
    'DISPID_SBSSeek', 'SDKLLocalMachine', 'eLEXTYPE_APP',
    'DISPID_SLGetWords', 'ISpeechRecoResult', 'SP_VISEME_14',
    'DISPID_SVPause', 'SVPNormal', 'DISPID_SGRSRule',
    'SPCT_SUB_DICTATION', 'SpObjectTokenCategory', 'DISPID_SFSClose',
    'SRSActiveAlways', 'SVP_10', 'SpeechGrammarTagWildcard',
    'SP_VISEME_16', 'ISpeechFileStream',
    'SpeechPropertyComplexResponseSpeed', 'SpeechTokenContext',
    'DISPID_SRCEFalseRecognition', 'DISPID_SRProfile',
    'DISPID_SRCState', 'DISPID_SGRAddState', 'DISPID_SBSFormat',
    'SpeechVoiceEvents', 'SAFT8kHz8BitMono', 'SREPropertyNumChange',
    'DISPID_SDKSetBinaryValue', 'SAFTCCITT_ALaw_8kHzMono', 'SVP_8',
    'DISPID_SGRsAdd', 'SAFT16kHz8BitStereo', 'SRADefaultToActive',
    'ISpeechPhraseInfoBuilder', 'SRTEmulated',
    'DISPID_SRGRecoContext', 'SRTSMLTimeout', 'ISpeechPhraseElement',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SVSLastResult',
    'SPPHRASEELEMENT', 'SAFTText', 'DISPID_SDKEnumKeys',
    'SSFMCreateForWrite', 'ISpGrammarBuilder', 'SPSUnknown',
    'SP_VISEME_12', 'DISPID_SPEs_NewEnum', 'Speech_Max_Word_Length',
    'DISPID_SPEActualConfidence', 'eLEXTYPE_PRIVATE14', 'SRSInactive',
    'DISPID_SMSADeviceId', 'SPDKL_LocalMachine', 'STSF_CommonAppData',
    'DISPID_SGRsCount', 'SPAUDIOBUFFERINFO', 'SPAR_Unknown',
    'SRTReSent', 'ISpEventSource', 'DISPID_SMSALineId',
    'IInternetSecurityManager', 'DISPID_SVSpeakStream',
    'DISPID_SRCVoice', 'DISPID_SpeechPhraseRules',
    'DISPID_SLGetPronunciations', 'SPSHT_EMAIL',
    'SPEI_SR_RETAINEDAUDIO', 'SAFTGSM610_44kHzMono', 'tagSTATSTG',
    'SPEI_SR_BOOKMARK', 'SpeechGrammarState',
    'DISPID_SVAudioOutputStream', 'eLEXTYPE_LETTERTOSOUND',
    'SVEAudioLevel', 'SAFTCCITT_ALaw_8kHzStereo',
    'SpeechCategoryVoices', 'DISPID_SRCEventInterests',
    'ISpeechLexiconWord', 'DISPID_SpeechMMSysAudio',
    'SPEI_PHRASE_START', 'SpeechGrammarWordType',
    'DISPID_SVGetVoices', 'SPSHT_Unknown', 'SPINTERFERENCE_TOOSLOW',
    'SRSActive', 'DISPID_SVGetAudioInputs', 'DISPID_SOTCGetDataKey',
    'ISpeechXMLRecoResult', 'ISpeechMMSysAudio',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SLWWord', 'SPCONTEXTSTATE',
    'ISpStreamFormat', 'DISPID_SVSLastBookmark',
    'DISPID_SRCERecognitionForOtherContext', 'SPSNotOverriden',
    'SAFT48kHz8BitStereo', 'SPEI_RECO_STATE_CHANGE',
    'SpeechInterference', 'DISPID_SPIGetDisplayAttributes',
    'SVPAlert', 'SPRST_NUM_STATES', 'ISpRecognizer2',
    'ISpeechObjectTokens', 'DISPID_SGRsCommit', 'SDKLDefaultLocation',
    'DISPID_SRSSupportedLanguages', 'DISPID_SVEEnginePrivate',
    'ISpPhoneticAlphabetConverter', 'DISPID_SRCBookmark',
    'SPWAVEFORMATTYPE', 'DISPID_SWFEChannels', 'SPSHORTCUTTYPE',
    'DISPID_SPCIdToPhone', 'ISpShortcut',
    'DISPID_SRSetPropertyNumber', 'DISPID_SRCERequestUI',
    'SpCustomStream', 'STCInprocHandler', 'DISPID_SPCPhoneToId',
    'DISPID_SPERetainedStreamOffset', 'SPCS_DISABLED',
    'DISPID_SDKSetStringValue', 'SPAO_RETAIN_AUDIO',
    'DISPID_SRCESoundStart', 'SPRST_INACTIVE_WITH_PURGE',
    'STSF_LocalAppData', 'eLEXTYPE_RESERVED9',
    'ISpeechAudioBufferInfo', 'DISPID_SRCRequestedUIType',
    'SPEI_SR_PRIVATE', 'SAFT24kHz8BitStereo',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SLWsItem',
    'DISPID_SRCERecognition', 'SGRSTTWord', 'DISPID_SRGRules',
    'SSFMOpenReadWrite', 'SLODynamic', 'SPSNoun', 'SRATopLevel',
    'SAFT32kHz16BitMono', 'SPEI_END_SR_STREAM', 'SVF_Emphasis',
    'SAFTCCITT_uLaw_44kHzStereo', 'SPSTREAMFORMATTYPE',
    'DISPID_SVVolume', 'SPLO_DYNAMIC', 'eLEXTYPE_PRIVATE2',
    'DISPID_SPPs_NewEnum', 'DISPID_SOTDisplayUI',
    'DISPID_SRGIsPronounceable', 'SAFT44kHz16BitMono', 'SPAR_High',
    'DISPID_SpeechLexiconPronunciation',
    'DISPID_SpeechRecoContextEvents', 'STCInprocServer', 'SPAS_PAUSE',
    'SpeechStreamSeekPositionType', 'SVP_2', 'SVEAllEvents',
    'DISPID_SRCRetainedAudioFormat', 'SECLowConfidence',
    'DISPID_SRCEPropertyNumberChange', 'ISpeechPhraseRules',
    'ISpeechRecoResultTimes', 'SVSFParseAutodetect', 'SPEI_MAX_SR',
    'SpeechAudioVolume', 'DISPID_SPPChildren',
    'SAFTADPCM_11kHzStereo', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SRGetRecognizers', 'SPEI_VISEME', 'SP_VISEME_13',
    'SAFT44kHz8BitStereo', 'SVP_7', 'ISpResourceManager',
    'SGDSActiveUserDelimited', 'DISPID_SABufferInfo',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SAFType', 'tagSPPROPERTYINFO',
    'DISPID_SPERequiredConfidence', 'SGSDisabled',
    'SpResourceManager', 'SAFTTrueSpeech_8kHz1BitMono',
    'SpeechCategoryPhoneConverters', 'SPRECOSTATE', 'SVP_1',
    'SpeechVoicePriority', 'ISpRecognizer3', 'SREStreamStart',
    'SPPHRASERULE', 'SAFT11kHz16BitMono',
    'DISPID_SLAddPronunciationByPhoneIds', 'SpVoice',
    'DISPID_SVAlertBoundary', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SPFM_NUM_MODES', 'SpeechEngineConfidence',
    'DISPID_SRCEInterference', 'DISPID_SRGDictationUnload',
    'SREAudioLevel', 'DISPID_SRAudioInput',
    'DISPID_SOTGetDescription', 'DISPID_SPIReplacements',
    'ISpeechMemoryStream', 'SVEBookmark', 'SP_VISEME_6',
    'DISPID_SPRFirstElement', 'SWPKnownWordPronounceable', 'SRAONone',
    'SPAUDIOOPTIONS', 'DISPID_SPIGrammarId', 'ISpProperties',
    'SSFMOpenForRead', 'DISPID_SLGenerationId',
    'DISPID_SRCCreateResultFromMemory', 'SPEI_ADAPTATION',
    'DISPID_SRCEEndStream', 'SVEPhoneme', 'DISPID_SPISaveToMemory',
    'DISPID_SRSetPropertyString',
    'SpeechPropertyLowConfidenceThreshold', 'SPINTERFERENCE',
    'SVESentenceBoundary', 'DISPID_SPRsItem', 'STCLocalServer',
    ...
    'DISPID_SVEPhoneme', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SpeechGrammarTagUnlimitedDictation', 'SPRECORESULTTIMES',
    'SDA_Two_Trailing_Spaces', 'SDTProperty',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SPRs_NewEnum',
    'DISPID_SRDisplayUI', 'SAFT32kHz8BitMono', 'SpeechTokenKeyUI',
    '_ISpeechVoiceEvents', 'DISPID_SRRTOffsetFromStart',
    'SpeechWordPronounceable', 'SAFT12kHz8BitStereo',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SVSCurrentStreamNumber',
    'DISPID_SpeechLexiconProns', 'SpeechRegistryUserRoot',
    'SpeechCategoryAudioOut', 'SPPHRASEREPLACEMENT',
    'DISPID_SREmulateRecognition', 'SPEI_RESERVED3',
    'DISPID_SpeechRecoResult2', 'SPPS_NotOverriden',
    'DISPID_SpeechRecoContext', 'SAFTCCITT_uLaw_11kHzMono',
    'SREAllEvents', 'SpWaveFormatEx', 'DISPID_SpeechAudio',
    'SPCT_DICTATION', 'DISPID_SRSClsidEngine', 'SPWORD',
    '__MIDL_IWinTypes_0009', 'SRERecognition', 'STCAll',
    'DISPID_SGRSTRule', 'DISPID_SPPNumberOfElements',
    'DISPID_SGRsItem', 'SPSLMA', 'DISPID_SWFEAvgBytesPerSec',
    'eLEXTYPE_PRIVATE8', 'SVSFIsXML', 'DISPID_SPPParent',
    'DISPID_SLPPhoneIds', 'DISPID_SRAudioInputStream',
    'ISpRecoContext2', 'DISPIDSPTSI_ActiveLength', 'ISpEventSink',
    'SPEI_RESERVED1', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SRIsUISupported',
    'ISpeechAudioFormat', 'SPAS_CLOSED', 'DISPID_SDKDeleteKey',
    'SPDATAKEYLOCATION', 'IEnumSpObjectTokens',
    'ISpeechTextSelectionInformation', 'SVSFPersistXML',
    'SpeechBookmarkOptions', 'DISPID_SVGetAudioOutputs', 'SVP_5',
    'DISPID_SPAPhraseInfo', 'DISPID_SRRSaveToMemory',
    'DISPID_SVESentenceBoundary', 'DISPID_SVEStreamEnd',
    'DISPID_SVEWord', 'DISPID_SpeechVoiceEvent', 'SRTAutopause',
    'SASStop', 'SPINTERFERENCE_TOOQUIET', 'ISpeechGrammarRuleState',
    'SPEI_HYPOTHESIS', 'DISPID_SPRNumberOfElements', 'SPRULE',
    'DISPID_SLPType', 'ISpeechGrammarRules', 'DISPID_SRRecognizer',
    'SGDisplay', 'DISPID_SRCEPropertyStringChange', 'SASClosed',
    'SECFEmulateResult', 'ISpeechPhraseRule', 'SPINTERFERENCE_NOISE',
    'DISPID_SOTIsUISupported', 'DISPID_SDKCreateKey',
    'SECFIgnoreKanaType', 'SGSEnabled', 'SPEI_MAX_TTS',
    'SPEI_START_INPUT_STREAM', 'SAFT48kHz8BitMono',
    'SAFTNonStandardFormat', 'ISpeechLexiconWords', 'SRESoundEnd',
    'ISpRecoCategory', 'DISPID_SRCERecognizerStateChange',
    'DISPID_SpeechPhoneConverter', 'ISpStream', 'SRAInterpreter',
    'DISPID_SASetState', 'SpInprocRecognizer', 'SPWORDPRONOUNCEABLE',
    'DISPID_SRRTimes', 'DISPID_SVSyncronousSpeakTimeout',
    'ISpeechRecognizer', 'SWTDeleted', 'SPINTERFERENCE_NOSIGNAL',
    'SPSERIALIZEDPHRASE', 'SRERequestUI', 'SLOStatic',
    'DISPID_SGRInitialState', 'SAFTNoAssignedFormat',
    'SpeechDictationTopicSpelling', 'ISpeechVoice', 'SPEI_PHONEME',
    'DISPID_SPPEngineConfidence', 'DISPID_SRCEAdaptation',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SpeechMemoryStream',
    'SpeechGrammarTagDictation', 'DISPID_SGRSTPropertyValue',
    'SpeechDataKeyLocation', 'SpeechAudioState', 'ISpMMSysAudio',
    'SpeechTokenShellFolder', 'DISPID_SRCResume',
    'ISpeechRecoResult2', 'eLEXTYPE_USER_SHORTCUT', 'SPLEXICONTYPE',
    'DISPID_SRRGetXMLResult', 'SGRSTTTextBuffer',
    'DISPID_SGRSTransitions', 'SPPS_Interjection', 'SPGS_DISABLED',
    'SPAS_STOP', 'DISPID_SpeechXMLRecoResult', 'DISPID_SRRTTickCount',
    'SpLexicon', 'SDTAlternates', 'DISPID_SMSGetData',
    'SPEVENTSOURCEINFO', 'SPWF_SRENGINE', 'SPDKL_CurrentConfig',
    'eLEXTYPE_USER', 'SpeechVoiceSkipTypeSentence', 'SVP_18',
    'SREBookmark', 'SPPHRASEPROPERTY', 'ISpAudio',
    'ISpeechRecoResultDispatch', 'SpeechPropertyAdaptationOn',
    'SP_VISEME_10', 'DISPID_SDKSetLongValue',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SAVolume',
    'DISPID_SPEsItem', 'DISPID_SPRules_NewEnum', 'SGRSTTWildcard',
    'SPGRAMMARWORDTYPE', 'ISpeechPhraseReplacement', 'SPVPRI_ALERT',
    'eLEXTYPE_RESERVED4', 'SPPS_RESERVED3', 'DISPID_SPEDisplayText',
    'DISPID_SWFEFormatTag', 'SPXRO_Alternates_SML', 'SpShortcut',
    'DISPID_SBSWrite', 'SPLO_STATIC', 'ISpeechPhraseProperties',
    'DISPID_SPAsCount', 'ISpRecoContext',
    'SpPhoneticAlphabetConverter', 'SPEI_TTS_AUDIO_LEVEL',
    'SPSMF_UPS', 'eLEXTYPE_VENDORLEXICON', 'SPEI_RESERVED5',
    'DISPID_SRCRecognizer', 'SPSHORTCUTPAIR', 'ISpRecognizer',
    'DISPID_SRCRetainedAudio', 'DISPID_SVStatus', 'DISPID_SPRuleName',
    'DISPID_SVSRunningState', 'DISPID_SLAddPronunciation',
    'SSTTTextBuffer', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SVIsUISupported', 'DISPID_SDKOpenKey',
    'SAFTExtendedAudioFormat', 'DISPID_SpeechPhraseAlternates',
    'SpeechRunState', 'DISPID_SRRAudio', 'SSSPTRelativeToStart',
    'SP_VISEME_15', 'UINT_PTR', 'SPBO_AHEAD', 'SPEI_UNDEFINED',
    'SPEI_MIN_SR', 'DISPID_SLGetGenerationChange', 'SPPROPERTYINFO',
    'DISPID_SRRTLength', 'SpeechRecoProfileProperties',
    'SpeechRecognizerState', 'ISpeechDataKey', 'SAFTADPCM_8kHzStereo',
    'DISPID_SRRSpeakAudio', 'STCRemoteServer', 'DISPID_SpeechVoice',
    'SpeechCategoryAudioIn', 'SPBO_TIME_UNITS', 'SRSEDone',
    'eLEXTYPE_PRIVATE3', 'SPEI_END_INPUT_STREAM',
    'DISPID_SPILanguageId', 'SGRSTTEpsilon', 'DISPID_SABIEventBias',
    'DISPID_SPRDisplayAttributes', 'DISPID_SLPs_NewEnum',
    'SVEPrivate', 'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SOTGetAttribute', 'SP_VISEME_18',
    'DISPID_SPRuleConfidence', 'SREAdaptation', 'DISPID_SGRName',
    'DISPID_SOTCategory', 'SPEI_SOUND_END', 'SPEVENT',
    'DISPID_SRSNumberOfActiveRules', 'SPPS_RESERVED4', 'SpStream',
    'DISPID_SPPConfidence', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SABIBufferSize', 'DISPID_SWFEBlockAlign', 'SVP_17',
    'DISPID_SPPValue', 'SRTExtendableParse', 'SpeechAudioFormatType',
    'DISPID_SVAudioOutput', 'SP_VISEME_17', 'DISPID_SGRId',
    'SREFalseRecognition', 'SpeechAllElements', 'SpSharedRecoContext',
    'SPCT_SLEEP', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SVEVoiceChange',
    'SVP_3', 'SVSFUnusedFlags', 'DISPID_SPIRule',
    'SpeechGrammarRuleStateTransitionType', 'SAFTADPCM_11kHzMono',
    'SpInProcRecoContext', 'SpeechStreamFileMode', 'SPFILEMODE',
    'SPPS_LMA', 'SpeechWordType', 'SVP_13', 'SREInterference',
    'DISPID_SASNonBlockingIO', '_SPAUDIOSTATE',
    'SpeechRetainedAudioOptions', 'SPGS_EXCLUSIVE', 'SPEI_RESERVED2',
    'DISPID_SRRTStreamTime', 'SPSFunction', 'SPGS_ENABLED',
    'SRAExport', 'SPEI_SENTENCE_BOUNDARY', 'SPCATEGORYTYPE',
    'SPEI_TTS_BOOKMARK', 'SREPropertyStringChange',
    'DISPID_SPIAudioStreamPosition', 'ISpeechObjectTokenCategory',
    'SpAudioFormat', 'SP_VISEME_19', 'eLEXTYPE_PRIVATE12',
    'DISPID_SGRSAddRuleTransition', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPIDSPTSI_SelectionLength',
    'SVP_9', 'ISpeechRecoContext', 'DISPID_SpeechFileStream',
    'SAFT22kHz16BitStereo', 'SVP_6', 'DISPID_SPIRetainedSizeBytes',
    'SpeechEmulationCompareFlags', 'eLEXTYPE_PRIVATE10',
    'SAFTCCITT_uLaw_22kHzMono', 'SpeechDisplayAttributes', 'IStream',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SPRText', 'SPSVerb',
    'DISPID_SPIElements', 'SAFT8kHz16BitStereo', 'DISPID_SOTsItem',
    'DISPID_SVSInputSentencePosition', 'DISPID_SOTCSetId',
    'ISpObjectTokenCategory', 'eLEXTYPE_RESERVED7',
    'DISPID_SVSLastBookmarkId', 'Speech_Max_Pron_Length',
    'ISpeechAudio', 'SPPHRASE', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SLWType', 'DISPID_SFSOpen', 'DISPID_SVSInputWordLength',
    'SINoSignal', 'SPTEXTSELECTIONINFO', 'SVP_21', 'SVP_12',
    'SPCT_COMMAND', 'SAFT48kHz16BitStereo', 'DISPID_SPPId',
    'DISPID_SpeechGrammarRuleState', 'SPVPRIORITY',
    'SpeechPropertyHighConfidenceThreshold', 'SPRST_ACTIVE',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SLPsItem',
    'STSF_FlagCreate', 'DISPID_SpeechGrammarRuleStateTransitions',
    'SPEI_RECO_OTHER_CONTEXT', 'SpeechMicTraining',
    'SPEI_SR_AUDIO_LEVEL', 'SAFT22kHz8BitMono',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SWPUnknownWordPronounceable', 'SVEViseme',
    'DISPID_SDKGetStringValue', 'ISpeechRecognizerStatus',
    'SpNullPhoneConverter', 'SP_VISEME_20', 'DISPID_SRCEAudioLevel',
    'DISPID_SRGDictationLoad', 'SVPOver', 'SDKLCurrentUser',
    'SGSExclusive', 'SDTAll', 'SRERecoOtherContext', 'SRTStandard',
    'DISPID_SPRuleId', 'DISPID_SVEAudioLevel', 'SAFT16kHz16BitMono',
    'SECFIgnoreWidth', 'DISPID_SpeechVoiceStatus',
    'DISPID_SpeechPhraseInfo', 'DISPID_SRCPause', 'SP_VISEME_9',
    'DISPID_SRSCurrentStreamNumber', 'DISPIDSPRG', 'SP_VISEME_21',
    'DISPIDSPTSI', 'SPWT_LEXICAL', 'ISpeechPhraseElements',
    'DISPID_SpeechPhraseElement', 'eLEXTYPE_PRIVATE9',
    'DISPID_SpeechPhraseProperty', 'SAFT32kHz8BitStereo',
    'SRCS_Enabled', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SVGetProfiles', 'DISPID_SVWaitUntilDone',
    'DISPID_SVVoice', 'Speech_StreamPos_Asap', 'SVEEndInputStream',
    'ISpStreamFormatConverter', 'SPSEMANTICERRORINFO',
    'SAFT16kHz8BitMono', 'SGRSTTRule', 'SRSEIsSpeaking',
    'SpStreamFormatConverter', 'SASRun', 'SPRECOCONTEXTSTATUS',
    'DISPID_SPEAudioSizeBytes', 'SAFT24kHz16BitStereo', 'SPAR_Medium',
    'DISPID_SPPFirstElement', 'SVSFlagsAsync',
    'DISPID_SADefaultFormat', 'SREStreamEnd',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SpeechDataKey', 'DISPID_SVRate',
    'SPRST_ACTIVE_ALWAYS', 'SDA_No_Trailing_Space', 'ISpDataKey',
    'SPPS_Noun', 'SITooQuiet', 'DISPID_SRRDiscardResultInfo',
    'SRARoot', 'eLEXTYPE_PRIVATE4', 'SVSFPurgeBeforeSpeak',
    'DISPID_SPAsItem', 'DISPID_SPEDisplayAttributes',
    'DISPID_SPRsCount', 'SRAImport', 'DISPID_SOTGetStorageFileName',
    'SPEI_RECOGNITION', 'SASPause', 'SAFTADPCM_8kHzMono',
    'DISPID_SVSVisemeId', 'SVP_19', 'DISPID_SpeechPhraseProperties',
    'DISPID_SpeechObjectToken', 'ISpPhraseAlt', 'DISPID_SMSSetData',
    'eLEXTYPE_RESERVED8', 'DISPID_SRGId', 'SPSHORTCUTPAIRLIST',
    'SPBOOKMARKOPTIONS', 'SPWF_INPUT', 'DISPID_SLPLangId',
    'SGLexical', 'ISpeechLexicon', 'DISPID_SVSInputSentenceLength',
    'SpeechVoiceSpeakFlags', 'eLEXTYPE_PRIVATE7', 'SPPS_RESERVED1',
    'ISpeechCustomStream', 'ISpeechPhraseReplacements',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SGRsCommitAndSave',
    'SRSInactiveWithPurge', 'SVSFParseSsml', 'SLTApp',
    'SPEI_VOICE_CHANGE', 'SPPS_Noncontent', 'SVSFIsFilename',
    'DISPID_SLWPronunciations',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SpeechTokenValueCLSID',
    'DISPID_SGRsFindRule', 'DISPID_SPACommit', 'SREPhraseStart',
    'DISPID_SPEPronunciation', 'DISPID_SOTMatchesAttributes',
    'DISPID_SLWsCount', 'SREHypothesis', 'SAFT8kHz8BitStereo',
    'eLEXTYPE_PRIVATE15', 'DISPID_SPPBRestorePhraseFromMemory',
    'SPGRAMMARSTATE', 'SPVISEMES', 'DISPID_SPEAudioSizeTime',
    'SPPS_Unknown', 'DISPID_SGRSAddWordTransition', 'DISPID_SGRClear',
    'SAFT24kHz16BitMono', 'DISPID_SPCLangId', 'SPSERIALIZEDRESULT',
    'DISPID_SAEventHandle', 'ISpRecoGrammar', 'SPVPRI_NORMAL',
    'eLEXTYPE_PRIVATE11', 'SpeechAudioFormatGUIDText',
    'SECFNoSpecialChars', 'DISPID_SRRPhraseInfo',
    'DISPID_SpeechGrammarRule', 'SVEWordBoundary', 'SBONone',
    'SPSHT_NotOverriden', 'SREPrivate', 'SWTAdded', 'SVP_16',
    'ISpNotifyTranslator', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    '_ISpeechRecoContextEvents', 'SITooSlow', 'DISPID_SVEViseme',
    'SVF_None', 'DISPID_SWFEBitsPerSample', 'DISPID_SGRSTs_NewEnum',
    'SP_VISEME_3', 'DISPID_SGRAttributes', 'SPSEMANTICFORMAT',
    'WAVEFORMATEX', 'SPPS_Modifier', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SWFESamplesPerSec', 'SpUnCompressedLexicon',
    'ISpeechPhoneConverter', 'ISpObjectWithToken',
    'SWPUnknownWordUnpronounceable', 'DISPID_SPPsItem',
    'ISpRecoGrammar2', 'DISPID_SPEEngineConfidence',
    'DISPID_SOTsCount', 'SPSModifier', 'ISpeechLexiconPronunciation',
    'DISPID_SGRSTNextState', 'SRCS_Disabled',
    'DISPID_SPIEnginePrivateData', 'ISpNotifySource', 'STSF_AppData',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SpeechCustomStream',
    'DISPID_SPRuleParent', 'DISPID_SVSkip', 'SPEI_WORD_BOUNDARY',
    'DISPID_SGRsDynamic', 'DISPID_SLPPartOfSpeech',
    'ISpeechGrammarRuleStateTransitions', 'LONG_PTR', 'SAFTDefault',
    'DISPID_SpeechLexiconWords', 'DISPID_SRGetPropertyString',
    'DISPID_SRGCmdSetRuleIdState', 'SGDSActiveWithAutoPause',
    'SDKLCurrentConfig', 'SVP_0', 'DISPIDSPTSI_SelectionOffset',
    'SPRS_INACTIVE', 'DISPID_SBSRead', 'DISPID_SGRAddResource',
    'SP_VISEME_2', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SRSCurrentStreamPosition', 'SPPS_RESERVED2',
    'DISPID_SVSpeakCompleteEvent', 'ISpeechPhraseInfo',
    'ISpeechVoiceStatus', 'DISPID_SLRemovePronunciation',
    'SPEI_RESERVED6', 'DISPID_SASFreeBufferSpace', 'DISPID_SASState',
    'SPBINARYGRAMMAR', 'DISPID_SPIAudioSizeBytes', 'SPWORDLIST',
    'ISpeechWaveFormatEx', 'DISPID_SGRSTText',
    'ISpPhoneticAlphabetSelection', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SPXRO_SML', 'SpeechRegistryLocalMachineRoot',
    'ISpeechGrammarRuleStateTransition', 'SpeechLexiconType',
    'SAFT44kHz16BitStereo', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SOTCId', 'SAFTADPCM_22kHzMono', 'ISpeechObjectToken',
    'DISPID_SVEventInterests', 'DISPID_SRState',
    'DISPID_SRGCmdLoadFromResource', 'SPAUDIOSTATUS', 'SINoise',
    'SAFTGSM610_8kHzMono', 'SITooLoud', 'DISPID_SPIAudioSizeTime',
    'SPWORDPRONUNCIATION', 'SSTTWildcard', 'ISpeechPhraseAlternates',
    'DISPID_SVEStreamStart', 'SpeechAddRemoveWord', 'SSTTDictation',
    'SPSHT_OTHER', 'DISPID_SGRs_NewEnum', 'DISPID_SVDisplayUI',
    'DISPID_SABIMinNotification', 'DISPID_SAFSetWaveFormatEx',
    'Speech_Default_Weight', 'DISPID_SRRSetTextFeedback',
    'SAFT16kHz16BitStereo', 'SDTRule', 'SPINTERFERENCE_NONE',
    'SP_VISEME_11', 'SpeechTokenIdUserLexicon', 'SPWORDTYPE',
    'tagSPTEXTSELECTIONINFO', 'ISpObjectToken', 'ISpRecoResult',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SVResume',
    'SpeechRecognitionType', 'DISPID_SOTId', 'eWORDTYPE_ADDED',
    'DISPID_SRCreateRecoContext', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SpeechLexiconWord', 'SAFT12kHz16BitMono',
    'ISpPhoneConverter', 'SFTInput', 'SpeechLoadOption',
    'SpeechRecoContextState', 'eLEXTYPE_RESERVED10',
    'DISPID_SpeechLexicon', 'DISPID_SPEAudioStreamOffset',
    'SPFM_OPEN_READWRITE', 'SpNotifyTranslator', 'SECFDefault',
    'DISPID_SOTRemove', 'SAFT11kHz8BitStereo', 'SPEI_MIN_TTS',
    'DISPID_SPAStartElementInResult', 'eWORDTYPE_DELETED',
    'DISPID_SDKEnumValues', 'DISPID_SRCEHypothesis',
    'DISPID_SGRSAddSpecialTransition', 'SPPS_SuppressWord',
    'DISPID_SAStatus', 'SpeechUserTraining', 'SPEI_REQUEST_UI',
    'SPWT_DISPLAY', 'ISpLexicon', 'eLEXTYPE_PRIVATE5',
    'ISpeechAudioStatus', 'DISPID_SPIEngineId', 'SRESoundStart',
    'SPEI_SOUND_START', 'SPPARTOFSPEECH',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SRGetFormat',
    'SpSharedRecognizer', 'DISPID_SRGSetTextSelection',
    'SPSSuppressWord', 'SAFT44kHz8BitMono',
    'SAFTCCITT_ALaw_44kHzMono', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SRCAudioInInterferenceStatus', 'SVSFVoiceMask',
    'DISPID_SGRSTPropertyName', 'SDA_Consume_Leading_Spaces',
    'SVSFParseMask', 'SVP_11', 'DISPID_SOTSetId',
    'DISPID_SpeechRecoResult', 'SpeechRuleState', 'SPAS_RUN',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SDTReplacement',
    'SP_VISEME_8', 'SAFTCCITT_ALaw_22kHzMono', 'SAFT12kHz8BitMono',
    'SpeechTokenKeyAttributes', 'SRADynamic', 'DISPID_SRIsShared',
    'SPEI_PROPERTY_NUM_CHANGE', 'ISpeechRecoGrammar',
    'SAFT12kHz16BitStereo', 'DISPID_SRGetPropertyNumber',
    'DISPID_SVSpeak', 'DISPID_SGRSTType', 'SpeechTokenKeyFiles',
    'ISpXMLRecoResult', 'ISpNotifySink', 'SPPS_Verb', 'SPRS_ACTIVE',
    'SDTPronunciation', 'SpMMAudioIn', 'DISPID_SRCEEnginePrivate',
    'SpeechVisemeFeature', 'DISPID_SRGCmdLoadFromObject',
    'DISPID_SPRuleNumberOfElements', 'SpeechSpecialTransitionType',
    'DISPID_SOTDataKey', 'DISPID_SLWLangId', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SVEBookmark', 'SpeechCategoryRecoProfiles',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SpeechGrammarRules',
    'DISPID_SpeechObjectTokenCategory', 'SPEVENTENUM',
    'DISPID_SRCEBookmark', 'SpeechVoiceCategoryTTSRate',
    'SECFIgnoreCase', 'SLTUser', 'SpFileStream', 'SVSFDefault',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SDKDeleteValue',
    'DISPID_SRCSetAdaptationData', 'DISPID_SRSAudioStatus',
    'SpCompressedLexicon', 'SGDSInactive', 'SpeechVisemeType',
    'DISPID_SpeechObjectTokens', 'DISPID_SPRuleChildren',
    'SP_VISEME_1', 'DISPID_SGRSTsCount', 'DISPID_SRGCmdLoadFromFile',
    'ISpVoice', 'Speech_StreamPos_RealTime', 'SAFT24kHz8BitMono',
    'DISPID_SVPriority', 'SVP_14', 'SAFTADPCM_44kHzMono',
    'ISpeechPhraseAlternate', 'DISPID_SRCESoundEnd', 'ISpPhrase',
    'SAFTGSM610_22kHzMono', 'SVEStartInputStream',
    'ISpeechPhraseProperty', 'DISPID_SGRSTsItem',
    'SGLexicalNoSpecialChars', 'SVSFParseSapi', 'SVP_20',
    'SPBO_PAUSE', 'SAFT11kHz16BitStereo', 'DISPID_SRCEPhraseStart',
    'SpeechCategoryAppLexicons', 'SITooFast',
    'SpeechCategoryRecognizers',
    'DISPID_SpeechGrammarRuleStateTransition', 'SREStateChange',
    'DISPID_SPARecoResult', 'SVP_4', 'SpPhoneConverter',
    'DISPID_SPEAudioTimeOffset', 'eLEXTYPE_PRIVATE19',
    'SPFM_CREATE_ALWAYS', 'SVSFNLPSpeakPunc', 'SGRSTTDictation',
    'DISPID_SpeechPhraseElements', 'SPFM_OPEN_READONLY',
    'DISPID_SRStatus', 'SDTAudio', 'SpeechDiscardType',
    'SPSMF_SAPI_PROPERTIES', 'SP_VISEME_7', 'SAFT32kHz16BitStereo',
    'eLEXTYPE_PRIVATE1', 'DISPID_SPAs_NewEnum', 'ISequentialStream',
    'SP_VISEME_5', 'eLEXTYPE_PRIVATE6', 'DISPID_SPRulesItem',
    'IEnumString', 'DISPID_SLPSymbolic', 'eLEXTYPE_PRIVATE20',
    'DISPID_SDKGetBinaryValue', 'SP_VISEME_4',
    'DISPID_SASCurrentSeekPosition', 'SGPronounciation',
    'SPVOICESTATUS', 'SVSFNLPMask', 'SPWORDPRONUNCIATIONLIST',
    'SVSFIsNotXML', 'DISPID_SGRSTPropertyId', 'eLEXTYPE_PRIVATE17',
    'DISPID_SPIProperties', 'DISPID_SPEsCount', 'SDTDisplayText',
    'SpMemoryStream', 'SPRECOGNIZERSTATUS', 'SDTLexicalForm',
    'DISPID_SRCCreateGrammar', 'SAFTADPCM_44kHzStereo',
    'DISPID_SOTCreateInstance', 'SINone', 'IInternetSecurityMgrSite',
    'SPEI_INTERFERENCE', 'DISPID_SABufferNotifySize',
    'SPEI_TTS_PRIVATE', 'SSFMCreate', 'DISPID_SLWs_NewEnum',
    'SVEVoiceChange', 'SPRULESTATE', 'SPRST_INACTIVE', 'SPCS_ENABLED',
    'SpObjectToken', 'SPAUDIOSTATE', 'DISPID_SOTCDefault',
    'DISPID_SpeechAudioStatus', 'DISPID_SPPName',
    'DISPID_SpeechBaseStream', 'DISPID_SRGReset',
    'SpPhraseInfoBuilder', 'ISpeechBaseStream',
    'DISPID_SpeechAudioFormat', 'DISPID_SpeechAudioBufferInfo',
    'DISPID_SRGDictationSetState', 'SAFT11kHz8BitMono',
    'DISPID_SpeechRecognizer', 'SpMMAudioOut', '_RemotableHandle',
    'DISPID_SRGCommit', 'SpeechPartOfSpeech',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SPEI_START_SR_STREAM',
    'eLEXTYPE_RESERVED6', 'SPDKL_CurrentUser',
    'SpeechAudioProperties', 'SPSInterjection', 'DISPID_SLPsCount',
    'SpeechRecoEvents', 'DISPID_SOTs_NewEnum', 'SBOPause',
    'DISPID_SMSAMMHandle', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SPELexicalForm', 'SSSPTRelativeToEnd',
    'DISPID_SVSInputWordPosition', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SGRSTWeight', 'ISpeechResourceLoader'
]
